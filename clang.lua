...
---@param arg_0 CXVirtualFileOverlay
---@param virtualPath string
---@param realPath string
---@return CXErrorCode
function clang.clang_VirtualFileOverlay_addFileMapping(arg_0, virtualPath, realPath) end
clang.VirtualFileOverlay_addFileMapping = clang.clang_VirtualFileOverlay_addFileMapping

---@param arg_0 CXVirtualFileOverlay
---@param caseSensitive integer
---@return CXErrorCode
function clang.clang_VirtualFileOverlay_setCaseSensitivity(arg_0, caseSensitive) end
...
---@return CXErrorCode
function clang.clang_VirtualFileOverlay_writeToBuffer(arg_0, options, out_buffer_ptr, out_buffer_size) end
...
---@param arg_0 CXVirtualFileOverlay
---@return nil
function clang.clang_VirtualFileOverlay_dispose(arg_0) end
...
---@param arg_0 CXModuleMapDescriptor
---@param name string
---@return CXErrorCode
function clang.clang_ModuleMapDescriptor_setFrameworkModuleName(arg_0, name) end
clang.ModuleMapDescriptor_setFrameworkModuleName = clang.clang_ModuleMapDescriptor_setFrameworkModuleName

---@param arg_0 CXModuleMapDescriptor
---@param name string
---@return CXErrorCode
function clang.clang_ModuleMapDescriptor_setUmbrellaHeader(arg_0, name) end
...
---@param out_buffer_size c.pointer<integer>
---@return CXErrorCode
function clang.clang_ModuleMapDescriptor_writeToBuffer(arg_0, options, out_buffer_ptr, out_buffer_size) end
clang.ModuleMapDescriptor_writeToBuffer = clang.clang_ModuleMapDescriptor_writeToBuffer

---@param arg_0 CXModuleMapDescriptor
---@return nil
function clang.clang_ModuleMapDescriptor_dispose(arg_0) end
...
---@param arg_0 CXDiagnostic
---@return CXDiagnosticSeverity
function clang.clang_getDiagnosticSeverity(arg_0) end
clang.getDiagnosticSeverity = clang.clang_getDiagnosticSeverity

---@param arg_0 CXDiagnostic
---@return CXSourceLocation
function clang.clang_getDiagnosticLocation(arg_0) end
clang.getDiagnosticLocation = clang.clang_getDiagnosticLocation

---@param arg_0 CXDiagnostic
---@return CXString
function clang.clang_getDiagnosticSpelling(arg_0) end
...
---@param arg_0 CXDiagnostic
---@return integer
function clang.clang_getDiagnosticCategory(arg_0) end
...
---@param arg_0 CXDiagnostic
---@return CXString
function clang.clang_getDiagnosticCategoryText(arg_0) end
clang.getDiagnosticCategoryText = clang.clang_getDiagnosticCategoryText

---@param arg_0 CXDiagnostic
---@return integer
function clang.clang_getDiagnosticNumRanges(arg_0) end
...
---@param options integer
---@return nil
function clang.clang_CXIndex_setGlobalOptions(arg_0, options) end
clang.CXIndex_setGlobalOptions = clang.clang_CXIndex_setGlobalOptions

---@param arg_0 CXIndex
---@return integer
function clang.clang_CXIndex_getGlobalOptions(arg_0) end
clang.CXIndex_getGlobalOptions = clang.clang_CXIndex_getGlobalOptions

---@param arg_0 CXIndex
---@param Path string
---@return nil
function clang.clang_CXIndex_setInvocationEmissionPathOption(arg_0, Path) end
...
---@param arg_0 CXTranslationUnit
---@return integer
function clang.clang_suspendTranslationUnit(arg_0) end
clang.suspendTranslationUnit = clang.clang_suspendTranslationUnit

---@param arg_0 CXTranslationUnit
---@return nil
function clang.clang_disposeTranslationUnit(arg_0) end
...
---@param arg_0 CXTranslationUnit
---@return CXCursor
function clang.clang_getTranslationUnitCursor(arg_0) end
clang.getTranslationUnitCursor = clang.clang_getTranslationUnitCursor

---@param arg_0 CXCursor
---@param arg_1 CXCursor
---@return integer
function clang.clang_equalCursors(arg_0, arg_1) end
...
---@param arg_0 CXCursor
---@return integer
function clang.clang_hashCursor(arg_0) end
clang.hashCursor = clang.clang_hashCursor

---@param arg_0 CXCursor
---@return CXCursorKind
function clang.clang_getCursorKind(arg_0) end
clang.getCursorKind = clang.clang_getCursorKind

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isDeclaration(arg_0) end
clang.isDeclaration = clang.clang_isDeclaration

---@param arg_0 CXCursor
---@return integer
function clang.clang_isInvalidDeclaration(arg_0) end
clang.isInvalidDeclaration = clang.clang_isInvalidDeclaration

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isReference(arg_0) end
clang.isReference = clang.clang_isReference

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isExpression(arg_0) end
clang.isExpression = clang.clang_isExpression

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isStatement(arg_0) end
clang.isStatement = clang.clang_isStatement

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isAttribute(arg_0) end
...
---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isInvalid(arg_0) end
clang.isInvalid = clang.clang_isInvalid

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isTranslationUnit(arg_0) end
clang.isTranslationUnit = clang.clang_isTranslationUnit

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isPreprocessing(arg_0) end
clang.isPreprocessing = clang.clang_isPreprocessing

---@param arg_0 CXCursorKind
---@return integer
function clang.clang_isUnexposed(arg_0) end
...
---@param arg_0 CXCursor
---@return CXTranslationUnit
function clang.clang_Cursor_getTranslationUnit(arg_0) end
...
---@param arg_0 CXTranslationUnit
---@param arg_1 CXSourceLocation
---@return CXCursor
function clang.clang_getCursor(arg_0, arg_1) end
clang.getCursor = clang.clang_getCursor

---@param arg_0 CXCursor
---@return CXSourceLocation
function clang.clang_getCursorLocation(arg_0) end
clang.getCursorLocation = clang.clang_getCursorLocation

---@param arg_0 CXCursor
---@return CXSourceRange
function clang.clang_getCursorExtent(arg_0) end
...
---@param arg_0 CXCursor
---@return integer
function clang.clang_isVirtualBase(arg_0) end
...
function clang.clang_getCXXAccessSpecifier(arg_0) end
...
function clang.clang_Cursor_getStorageClass(arg_0) end
...
---@param arg_0 CXCursor
---@return CXType
function clang.clang_getIBOutletCollectionType(arg_0) end
...
---@param arg_0 CXCursor
---@return CXString
function clang.clang_getCursorUSR(arg_0) end
...
---@param arg_0 CXCursor
---@return CXString
function clang.clang_getCursorSpelling(arg_0) end
...
---@param options integer
---@return CXSourceRange
function clang.clang_Cursor_getSpellingNameRange(arg_0, pieceIndex, options) end
...
function clang.clang_getCursorPrintingPolicy(arg_0) end
...
---@param arg_0 CXCursor
---@return CXString
function clang.clang_getCursorDisplayName(arg_0) end
clang.getCursorDisplayName = clang.clang_getCursorDisplayName

---@param arg_0 CXCursor
---@return CXCursor
function clang.clang_getCursorReferenced(arg_0) end
clang.getCursorReferenced = clang.clang_getCursorReferenced

---@param arg_0 CXCursor
---@return CXCursor
function clang.clang_getCursorDefinition(arg_0) end
clang.getCursorDefinition = clang.clang_getCursorDefinition

---@param arg_0 CXCursor
---@return integer
function clang.clang_isCursorDefinition(arg_0) end
clang.isCursorDefinition = clang.clang_isCursorDefinition

---@param arg_0 CXCursor
---@return CXCursor
function clang.clang_getCanonicalCursor(arg_0) end
clang.getCanonicalCursor = clang.clang_getCanonicalCursor

---@param arg_0 CXCursor
---@return integer
function clang.clang_Cursor_getObjCSelectorIndex(arg_0) end
...
---@param arg_0 CXCursor
---@return CXString
function clang.clang_Cursor_getMangling(arg_0) end
clang.Cursor_getMangling = clang.clang_Cursor_getMangling

---@param arg_0 CXCursor
---@return c.pointer<CXStringSet>
function clang.clang_Cursor_getCXXManglings(arg_0) end
clang.Cursor_getCXXManglings = clang.clang_Cursor_getCXXManglings

---@param arg_0 CXCursor
---@return c.pointer<CXStringSet>
function clang.clang_Cursor_getObjCManglings(arg_0) end
...
---@param arg_1 CXFile
---@return CXModule
function clang.clang_getModuleForFile(arg_0, arg_1) end
...
---@param Module CXModule
---@return integer
function clang.clang_Module_getNumTopLevelHeaders(arg_0, Module) end
...
---@param Index integer
---@return CXFile
function clang.clang_Module_getTopLevelHeader(arg_0, Module, Index) end
...
---@param arg_0 CXToken
---@return CXTokenKind
function clang.clang_getTokenKind(arg_0) end
clang.getTokenKind = clang.clang_getTokenKind

---@param arg_0 CXTranslationUnit
---@param arg_1 CXToken
---@return CXString
function clang.clang_getTokenSpelling(arg_0, arg_1) end
clang.getTokenSpelling = clang.clang_getTokenSpelling

---@param arg_0 CXTranslationUnit
---@param arg_1 CXToken
---@return CXSourceLocation
function clang.clang_getTokenLocation(arg_0, arg_1) end
clang.getTokenLocation = clang.clang_getTokenLocation

---@param arg_0 CXTranslationUnit
---@param arg_1 CXToken
---@return CXSourceRange
function clang.clang_getTokenExtent(arg_0, arg_1) end
...
---@return nil
function clang.clang_getDefinitionSpellingAndExtent(arg_0, startBuf, endBuf, startLine, startColumn, endLine, endColumn) end
...
---@param arg_0 CXRemapping
---@return integer
function clang.clang_remap_getNumFiles(arg_0) end
...
---@return nil
function clang.clang_remap_getFilenames(arg_0, index, original, transformed) end
clang.remap_getFilenames = clang.clang_remap_getFilenames

---@param arg_0 CXRemapping
---@return nil
function clang.clang_remap_dispose(arg_0) end
...
---@param arg_0 CXCursor
---@param arg_1 CXFile
---@param arg_2 CXCursorAndRangeVisitorBlock
---@return CXResult
function clang.clang_findReferencesInFileWithBlock(arg_0, arg_1, arg_2) end
...
---@param arg_2 CXCursorAndRangeVisitorBlock
---@return CXResult
function clang.clang_findIncludesInFileWithBlock(arg_0, arg_1, arg_2) end
...
---@param arg_0 CXIdxEntityKind
---@return integer
function clang.clang_index_isEntityObjCContainerKind(arg_0) end
clang.index_isEntityObjCContainerKind = clang.clang_index_isEntityObjCContainerKind

---@param arg_0 c.pointer<CXIdxDeclInfo>
---@return c.pointer<CXIdxObjCContainerDeclInfo>
function clang.clang_index_getObjCContainerDeclInfo(arg_0) end
...
function clang.clang_index_getObjCInterfaceDeclInfo(arg_0) end
...
function clang.clang_index_getObjCCategoryDeclInfo(arg_0) end
...
function clang.clang_index_getObjCProtocolRefListInfo(arg_0) end
...
function clang.clang_index_getObjCPropertyDeclInfo(arg_0) end
clang.index_getObjCPropertyDeclInfo = clang.clang_index_getObjCPropertyDeclInfo

---@param arg_0 c.pointer<CXIdxAttrInfo>
---@return c.pointer<CXIdxIBOutletCollectionAttrInfo>
function clang.clang_index_getIBOutletCollectionAttrInfo(arg_0) end
...
function clang.clang_index_getCXXClassDeclInfo(arg_0) end
clang.index_getCXXClassDeclInfo = clang.clang_index_getCXXClassDeclInfo

---@param arg_0 c.pointer<CXIdxContainerInfo>
---@return CXIdxClientContainer
function clang.clang_index_getClientContainer(arg_0) end
clang.index_getClientContainer = clang.clang_index_getClientContainer

---@param arg_0 c.pointer<CXIdxContainerInfo>
---@param arg_1 CXIdxClientContainer
---@return nil
function clang.clang_index_setClientContainer(arg_0, arg_1) end
clang.index_setClientContainer = clang.clang_index_setClientContainer

---@param arg_0 c.pointer<CXIdxEntityInfo>
---@return CXIdxClientEntity
function clang.clang_index_getClientEntity(arg_0) end
clang.index_getClientEntity = clang.clang_index_getClientEntity

---@param arg_0 c.pointer<CXIdxEntityInfo>
---@param arg_1 CXIdxClientEntity
---@return nil
function clang.clang_index_setClientEntity(arg_0, arg_1) end
...
---@param arg_0 CXIndexAction
---@return nil
function clang.clang_IndexAction_dispose(arg_0) end
...
---@return integer
function clang.clang_indexSourceFile(arg_0, client_data, index_callbacks, index_callbacks_size, index_options, source_filename, command_line_args, num_command_line_args, unsaved_files, num_unsaved_files, out_TU, TU_options) end
...
---@param TU_options integer
---@return integer
function clang.clang_indexSourceFileFullArgv(arg_0, client_data, index_callbacks, index_callbacks_size, index_options, source_filename, command_line_args, num_command_line_args, unsaved_files, num_unsaved_files, out_TU, TU_options) end
...
---@param index_callbacks_size integer
---@param index_options integer
---@param arg_5 CXTranslationUnit
---@return integer
function clang.clang_indexTranslationUnit(arg_0, client_data, index_callbacks, index_callbacks_size, index_options, arg_5) end
